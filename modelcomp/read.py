...
def read_data(read_from_unjoined):
    ...
    precisions = []
    recalls = []
    accuracies = np.genfromtxt(os.path.join(save_to, "accuracies.csv"), delimiter=",")
    count = 0
    while os.path.exists(os.path.join(save_to, "interp_tpr" + str(count) + ".csv")):
        interp_tpr.append(
            np.genfromtxt(
                os.path.join(save_to, "interp_tpr" + str(count) + ".csv"), delimiter=","
            )
        )
        count += 1
    count = 0
    while os.path.exists(os.path.join(save_to, "interp_recall" + str(count) + ".csv")):
        interp_recall.append(
            np.genfromtxt(
                os.path.join(save_to, "interp_recall" + str(count) + ".csv"),
                delimiter=",",
            )
        )
        count += 1
    ...
    if os.path.exists(os.path.join(save_to, "feature_importance.csv")):
        feature_importances = pd.read_csv(
            os.path.join(save_to, "feature_importance.csv"), index_col=0
        )
    else:
    ...
    while os.path.exists(os.path.join(save_to, "fpr" + str(count) + ".csv")):
        fprs.append(
            np.genfromtxt(
                os.path.join(save_to, "fpr" + str(count) + ".csv"), delimiter=","
            )
        )
        count += 1
    count = 0
    while os.path.exists(os.path.join(save_to, "tpr" + str(count) + ".csv")):
        tprs.append(
            np.genfromtxt(
                os.path.join(save_to, "tpr" + str(count) + ".csv"), delimiter=","
            )
        )
        count += 1
    count = 0
    while os.path.exists(os.path.join(save_to, "precision" + str(count) + ".csv")):
        precisions.append(
            np.genfromtxt(
                os.path.join(save_to, "precision" + str(count) + ".csv"), delimiter=","
            )
        )
        count += 1
    count = 0
    while os.path.exists(os.path.join(save_to, "recall" + str(count) + ".csv")):
        recalls.append(
            np.genfromtxt(
                os.path.join(save_to, "recall" + str(count) + ".csv"), delimiter=","
            )
        )
        count += 1
